    ...
    <div>
      <section>
        <div className="w-full" id="home">
          ...
          >
            <motion.div 
              className="text-center bg-gradient-to-r from-pink-300 via-purple-400 to-pink-500 bg-clip-text text-xl tracking-tight text-transparent"
              initial={{ y: -50 }} // Slide in from above
              animate={{ y: 0 }}
            ...
            <div className="flex flex-wrap justify-between">
              ...
              >
                ...
                <div className="mt-5">
                  <Link to="/resume">
                    <motion.button 
                      className="bg-primaryColor text-secondaryColor px-4 py-2 rounded"
